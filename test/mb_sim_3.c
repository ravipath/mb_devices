...
static mb_device_data_map_t mb_data_map[] = {
    {.start_addr = 0, .datatype = "INT16", .format = "ABCD", .dp_value_range = CONSTANT, .max_value = -1, .min_value = -1, .value.i_data = 301, .step = -1},
    {.start_addr = 1, .datatype = "INT16", .format = "ABCD", .dp_value_range = CONSTANT, .max_value = -1, .min_value = -1, .value.i_data = 302, .step = -1},
};
